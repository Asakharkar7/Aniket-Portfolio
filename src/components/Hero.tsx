      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="text-center">
         ...
         <a 
           ...
           <span 
              className="text-slate-600">+1 857-230-5126</span> 
         </div> 
          <div 
              className="flex justify-center gap-4 mb-10 flex-wrap animate-slide-up"> 
            <a 
              href="https://www.linkedin.com/in/aniketsakharkar/" target="_blank" rel="noopener noreferrer" 
